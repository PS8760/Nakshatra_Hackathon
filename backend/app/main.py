...
from app.routers import auth, sessions, analytics, cognitive, ai as ai_router, referral as referral_router, progress, training, pose as pose_router, exercises as exercises_router
